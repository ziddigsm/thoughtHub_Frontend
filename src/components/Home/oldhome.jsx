  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#ffffff] text-white font-sans">
      <div className="flex flex-1">
        ...
        <section className={`relative w-1/2 bg-[url('src/assets/bg.jpg')] bg-cover bg-center p-12 ${isModalOpen ? "blur-sm" : ""}`}>
      ...
      >
        <div className="flex flex-col items-center">
          <p className="text-lg font-bold mb-4">&copy; 2024 ThoughtHub. All rights reserved.</p>
